...
def load_and_process(path: str, used_columns: list, replaceUni:bool=True, shouldScale:bool=False, shouldDropNA:bool=True) -> pd.DataFrame:
    # read data from csv
    df = pd.read_csv(path)
    if('test_input.csv' in path):
